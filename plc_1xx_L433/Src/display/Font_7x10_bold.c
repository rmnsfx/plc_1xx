...
// Шрифт 7 на 10 пикселов утолщенный (Bold).
// Повторяет шрифт DOSApp-105 (7 на 12) Microsoft Windows (обрезаны две нижние строки).

//__flash struct FONT Font_7x10_bold =
//{
...
static const uint8_t Font_7x10_bold_Data[] =
{
...
FontDef Font_7x10_bold = {7,10,Font_7x10_bold_Data};
